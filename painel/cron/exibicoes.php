<?php
    include("../includes/connect.php");
            ...
            // Alimentação das exibições ///////////////////////// PUBLICACOES 

            
            $gnd = "select codigo, dias_semana, estacoes, data_inicial, data_final from produto where NOW() between data_inicial and data_final";
            $gndr = mysql_query($gnd);
            
            if(mysql_num_rows($gndr)){


                while(list($cod, $dias, $estacoes, $data_inicial, $data_final) = mysql_fetch_row($gndr)){
            ...
            // Fim da alimentação das exibições /////////////////////////  PUBLICACOES 
            ...
            // Alimentação das exibições ///////////////////////// AVISOS
            
            
            $gnd = "select codigo, dias_semana, estacoes, data_inicial, data_final from aviso where NOW() between data_inicial and data_final";
            $gndr = mysql_query($gnd);
            ...
            // Fim da alimentação das exibições ///////////////////////// AVISOS
            
            
            
            
            // Alimentação das exibições ///////////////////////// AUDIOS

            $gnd = "select codigo, dias_semana, estacoes, data_inicial, data_final from audios where NOW() between data_inicial and data_final";
            $gndr = mysql_query($gnd);
            ...
            // Fim da alimentação das exibições ///////////////////////// AUDIOS
