...
<div id="conteudo_publicacoes">
        ...
        <?php if($d2->posicao == 1){?>
                ...
                <div style="position:relative; width:50%; height:100%; float:left; color:#333 !important;font-size:55px; font-weight:bold; text-align:center; vertical-align: middle;">
        ...
        <?php }else if($d2->posicao == 3){ ?>
                ...
                <div style="position:relative; width:100%; height:100%; float:left; color:#333 !important;font-size:55px; font-weight:bold; text-align:center; vertical-align: middle;">
                    <?=utf8_encode($d2->texto)?>
                </div>
