...
<audio id="TempoAudio" autoplay="autoplay" controls="controls" preload="auto" style="position:absolute; padding:20px; border-radius:10px; background-color:#eee; color:#333; text-align:center; left:20px; top:10px; width:auto; font-size:20px; z-index:90;">
